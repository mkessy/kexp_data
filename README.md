I'll help you review the codebase and generate a detailed summary. Let me start by exploring the project structure to understand what we're working with.

Ran tool
This appears to be a Python project with a well-organized structure. Let me examine the key files and directories to understand the project better.
...
Read file: README.md
The README is empty, so let me examine the source code and other directories to understand the project better.
...
Read file: config/labels.txt

Ran tool

Ran tool

Read file: docs/annotation_schema.md

Read file: docs/phase_a_ner_annotation.md

Ran tool

Ran tool

Read file: src/scripts/00_extract_kexp_comments.py

Read file: src/kexp_processing_utils/comment_parser.py

Read file: prodigy_recipes/prelabel_ent_spans_manual.py
Now let me examine the setup script to understand the project setup:

Read file: setup.sh
Now let me examine some sample data to understand the structure better:

Ran tool
Based on my comprehensive review of the codebase, here's a detailed summary of the **KEXP Data Processing and Annotation Project**:
